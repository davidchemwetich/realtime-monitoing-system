...
return [
    ...
    */
    ...
    'recorders' => [
            // Cache hit/miss ratios monitoring - REQUIRED
        Recorders\CacheInteractions::class => [
            'enabled' => env('PULSE_CACHE_INTERACTIONS_ENABLED', true),
            'sample_rate' => env('PULSE_CACHE_INTERACTIONS_SAMPLE_RATE', 1),
            'threshold' => env('PULSE_CACHE_INTERACTIONS_THRESHOLD', 100), // 100ms threshold
            'ignore' => [
            ...
            'groups' => [
                ...
                '/^user_message_count_.*/' => 'user_message_count:*', // Group your chat cache keys
                '/^daily_messages_.*/' => 'daily_messages:*',
        ...
        Recorders\Exceptions::class => [
            ...
            'ignore' => [
                '/^Illuminate\\\\Validation\\\\/', // Ignore validation exceptions
                '/^Symfony\\\\Component\\\\HttpKernel\\\\Exception\\\\NotFoundHttpException/',
            ],
        ],

            // Queue jobs monitoring - REQUIRED
        Recorders\Queues::class => [
            'enabled' => env('PULSE_QUEUES_ENABLED', true),
            'sample_rate' => env('PULSE_QUEUES_SAMPLE_RATE', 1),
            'ignore' => [
                // Don't ignore your ProcessBroadcastMessage job - we want to monitor it
            ],
        ],
        ...
        Recorders\Servers::class => [
            ...
            // Slow jobs monitoring - REQUIRED for queue processing times
        Recorders\SlowJobs::class => [
            'enabled' => env('PULSE_SLOW_JOBS_ENABLED', true),
            'sample_rate' => env('PULSE_SLOW_JOBS_SAMPLE_RATE', 1),
            'threshold' => env('PULSE_SLOW_JOBS_THRESHOLD', 1000), // 1 second
            'location' => env('PULSE_SLOW_JOBS_LOCATION', true),
            'ignore' => [
                // Monitor your ProcessBroadcastMessage job - don't ignore it
            ],
        ],
        ...
        Recorders\SlowOutgoingRequests::class => [
            ...
            // Slow database queries monitoring - REQUIRED
        Recorders\SlowQueries::class => [
            'enabled' => env('PULSE_SLOW_QUERIES_ENABLED', true),
            'sample_rate' => env('PULSE_SLOW_QUERIES_SAMPLE_RATE', 1),
            'threshold' => env('PULSE_SLOW_QUERIES_THRESHOLD', 500), // Lower threshold for better monitoring
            'location' => env('PULSE_SLOW_QUERIES_LOCATION', true),
            'max_query_length' => env('PULSE_SLOW_QUERIES_MAX_QUERY_LENGTH', 500),
            'ignore' => [
            ...
            // Request throughput monitoring - REQUIRED
        ...
        Recorders\UserJobs::class => [
            ...
            'ignore' => [
                // Monitor your ProcessBroadcastMessage job
            ],
        ],

            // User requests monitoring - REQUIRED for request throughput
        ...
        // The Custom broadcast event recorder for monitoring broadcast events
        \App\Pulse\Recorders\BroadcastEventRecorder::class => [
            'enabled' => env('PULSE_BROADCAST_EVENTS_ENABLED', true),
            'sample_rate' => env('PULSE_BROADCAST_EVENTS_SAMPLE_RATE', 1),
            'ignore' => [
                // Add any broadcast events you want to ignore
            ],
        ],
    ],
];